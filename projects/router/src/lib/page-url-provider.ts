...
export const MATOMO_PAGE_URL_PROVIDER = new InjectionToken<PageUrlProvider>('MATOMO_PAGE_URL_PROVIDER', {
  factory: () => new DefaultPageUrlProvider(
...
export class DefaultPageUrlProvider implements PageUrlProvider {
  ...
  constructor(@Optional() @Inject(INTERNAL_ROUTER_CONFIGURATION) private readonly config: InternalRouterConfiguration,
