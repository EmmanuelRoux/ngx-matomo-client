...
import {ExclusionConfig, INTERNAL_ROUTER_CONFIGURATION, InternalRouterConfiguration} from './configuration';
...
export class MatomoRouter {
  ...
  constructor(private readonly router: Router,
              @Inject(INTERNAL_ROUTER_CONFIGURATION) private readonly config: InternalRouterConfiguration,
              @Inject(MATOMO_PAGE_TITLE_PROVIDER) private readonly pageTitleProvider: PageTitleProvider,
              @Inject(MATOMO_PAGE_URL_PROVIDER) private readonly pageUrlProvider: PageUrlProvider,
